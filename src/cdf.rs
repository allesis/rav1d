...
static DEFAULT_CDF: CdfDefaultContext = CdfDefaultContext {
    ...
    m: CdfModeContext {
        ...
        marker: Align4(cdf1d([[31671], [16515], [4576]])),
        pal_y: Align4(cdf2d([
            [[31676], [3419], [1261]],
            [[31912], [2859], [980]],
            [[31823], [3400], [781]],
...
pub(crate) fn rav1d_cdf_thread_update(
    ...
    update_cdf_3d!(TxfmSize::NUM_SQUARE, 13, 1, coef.marker);
